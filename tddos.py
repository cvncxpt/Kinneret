...
# 
#
# author : kaya hanh han , version 1.0
# ----------------------------------------------------------------------------------------------
import urllib2
import sys
import threading
...
def usage():
	print 'pew pew DDoS Tool ( individual Dangerous Denial of Service )'
	print 'New loaded T7-Botnets: 1,798,445,657'
	print 'Usage: tddos (url or ip)'
	print 'Example: python2 tddos.py http://luthi.co.il/ or python2 tddos.py 1.1.1.1'
	print "\a"
print \
"""
